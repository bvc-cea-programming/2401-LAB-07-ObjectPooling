...
public class WeaponShootPooled : MonoBehaviour
{
    ...
    private void Shoot()
    {
        ...
        pooledBullet.transform.position = shootPosition.position;
        pooledBullet.transform.rotation = shootPosition.rotation;
